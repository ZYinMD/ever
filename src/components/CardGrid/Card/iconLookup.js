...
const lookUpTable = {
  ...
  "Credentialing type": faIdBadge,
  "Committee Date": faCalendarAlt,
  "Committee Results": faClipboardListCheck,
  'Non-Responder Indicator': faRetweet,
  "Non-Responder Date from CVO": faCalendarAlt,
  "Delegated Services": faUsersCrown,
  "Risk Designation": faIdCardAlt,
  "Site of Service (SOS)": faBell,
  "Timely Claim Filing Limit (TCF)": faEnvelopeOpenDollar,
  "Prov Admin Drug Prgm (PADP)": faPills,
  "Physician Extender (PE)": faUserMd,
  "Value Based Reimbursement": faFileInvoiceDollar,
  "Member Threshold": faUserChart
};
