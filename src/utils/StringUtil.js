...
export const toTitleCase = (str) => str.replace(/\w\S*/g, function(txt){return txt.charAt(0).toUpperCase() + txt.substr(1).toLowerCase();});

/* Change into Upper Case   */
export const psvUpperCase = (str) => str.toUpperCase();

/* Change into Lower Case   */
export const psvLowerCase = (str) => str.toLowerCase();
